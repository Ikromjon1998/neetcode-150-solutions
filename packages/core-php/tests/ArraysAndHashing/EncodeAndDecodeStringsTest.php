...
final class EncodeAndDecodeStringsTest extends TestCase
{
    ...
    {
        $solve = EncodeAndDecodeStrings::solutions()[$approach];
    ...
    public function all_approaches_agree(array $input): void
    {
        $results = array_map(
            ...
            EncodeAndDecodeStrings::solutions(),
        );
    ...
    public static function contractCases(): iterable
    {
        ...
        foreach (array_keys(EncodeAndDecodeStrings::solutions()) as $approach) {
            foreach ($contracts->cases(EncodeAndDecodeStrings::SLUG) as $case) {
    ...
    {
        foreach ((new ContractRepository())->cases(EncodeAndDecodeStrings::SLUG) as $case) {
