...
final class ContainsDuplicateTest extends TestCase
{
    ...
    {
        $solve = ContainsDuplicate::solutions()[$approach];
    ...
    public static function contractCases(): iterable
    {
        ...
        foreach (array_keys(ContainsDuplicate::solutions()) as $approach) {
            foreach ($contracts->cases(ContainsDuplicate::SLUG) as $case) {
    ...
    {
        foreach ((new ContractRepository())->cases(ContainsDuplicate::SLUG) as $case) {
