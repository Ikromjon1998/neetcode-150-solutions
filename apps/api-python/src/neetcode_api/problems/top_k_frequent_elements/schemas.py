"""Request model for `POST /problems/top-k-frequent-elements`.
...
class TopKFrequentElementsRequest(BaseModel):
    model_config = ConfigDict(extra="forbid")

    nums: list[StrictInt] = Field(description="TODO: what this field means.")
    k: StrictInt = Field(description="TODO: what this field means.")
