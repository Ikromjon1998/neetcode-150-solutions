...
from neetcode_api.problems.longest_consecutive_sequence.schemas import (
    LongestConsecutiveSequenceRequest,
)
from neetcode_api.problems.longest_consecutive_sequence.service import (
    SLUG,
    LongestConsecutiveSequenceService,
)
...
@router.post(
    f"/{SLUG}",
    summary="Solve Longest Consecutive Sequence",
    response_model=SolveResponse[int],
