"""Request model for `POST /problems/encode-and-decode-strings`.
...
class EncodeAndDecodeStringsRequest(BaseModel):
    model_config = ConfigDict(extra="forbid")

    strs: list[StrictStr] = Field(description="TODO: what this field means.")
