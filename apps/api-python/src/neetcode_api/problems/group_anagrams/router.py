...
from neetcode_api.problems.group_anagrams.schemas import GroupAnagramsRequest
from neetcode_api.problems.group_anagrams.service import SLUG, GroupAnagramsService
...
@router.post(
    f"/{SLUG}",
    summary="Solve Group Anagrams",
    response_model=SolveResponse[list[list[str]]],
