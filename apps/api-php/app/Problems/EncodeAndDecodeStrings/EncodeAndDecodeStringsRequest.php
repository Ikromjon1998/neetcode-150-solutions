...
/**
 * Request validation for `POST /problems/encode-and-decode-strings`.
 *
 ...
 */
final class EncodeAndDecodeStringsRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            'strs' => ['present', 'array'],
            'strs.*' => ['present', $this->strictType('is_string', 'strs.*')],
        ];
    }
    ...
    {
        $unexpected = array_diff(array_keys($this->json()->all()), ['strs']);
