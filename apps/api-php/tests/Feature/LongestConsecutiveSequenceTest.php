...
/** `POST /problems/longest-consecutive-sequence`, driven by the shared JSON contract. */
final class LongestConsecutiveSequenceTest extends TestCase
{
    private const URL = '/problems/longest-consecutive-sequence';
    ...
    {
        return ContractCases::perApproach(LongestConsecutiveSequence::SLUG, array_keys(LongestConsecutiveSequence::solutions()));
    }

    /** @return iterable<string, array{array<string, mixed>, int}> */
    public static function validationCases(): iterable
    {
        return ContractCases::plain(LongestConsecutiveSequence::SLUG, 'validationCases');
    }
}
