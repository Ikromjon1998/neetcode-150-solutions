...
{
    private const URL = '/problems/group-anagrams';
    ...
    {
        return ContractCases::perApproach(GroupAnagrams::SLUG, array_keys(GroupAnagrams::solutions()));
    }

    /** @return iterable<string, array{array<string, mixed>, int}> */
    public static function validationCases(): iterable
    {
        return ContractCases::plain(GroupAnagrams::SLUG, 'validationCases');
    }
}
