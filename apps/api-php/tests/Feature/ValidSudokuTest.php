...
/** `POST /problems/valid-sudoku`, driven by the shared JSON contract. */
final class ValidSudokuTest extends TestCase
{
    private const URL = '/problems/valid-sudoku';
    ...
    {
        return ContractCases::perApproach(ValidSudoku::SLUG, array_keys(ValidSudoku::solutions()));
    }

    /** @return iterable<string, array{array<string, mixed>, int}> */
    public static function validationCases(): iterable
    {
        return ContractCases::plain(ValidSudoku::SLUG, 'validationCases');
    }
}
